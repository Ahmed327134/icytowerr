...
int main() {
	...
	settextgameover();
	textresume();
	cout << "Ahmed & Abd ElAsis";
	defultnumtheme = num_sel_theme;
	while (window.isOpen()) {
		Event event;
		...
		else if (screen == 1)
		{
			...
			if (score % 530 == 0 && flag == true && score > 0) {
				if (num_sel_theme == 3) {
					num_sel_theme = 0;
				}
				if (num_sel_theme < 3) {
...
{
	if (num_sel_theme == 1) {
		picture2.loadFromFile("background1111111111.PNG");
		picture22.loadFromFile("background1111111111.PNG");
		s22.setTexture(picture22);
		s2.setTexture(picture2);
		s2.setPosition(pxbg1, pybg1);
		s22.setPosition(pxbg2, pybg2);
		window.draw(s2);
		window.draw(s22);
		draw_plats();
		...
		*/
		...
		picture3.loadFromFile("fe0a1b7d-b988-45b3-bd3a-e39a7d033b34.jpg");
		picture22.loadFromFile("fe0a1b7d-b988-45b3-bd3a-e39a7d033b34.jpg");
		s3.setTexture(picture3);
		s22.setTexture(picture22);
		s3.setPosition(pxbg1, pybg1);
		s22.setPosition(pxbg2, pybg2);
		window.draw(s3);
		window.draw(s22);
		draw_plats();
		...
		*/
		...
		picture4.loadFromFile("background2222222222222222.png");
		s4.setTexture(picture4);
		s4.setPosition(0, 0);
		window.draw(s4);
		draw_plats();
		window.draw(scoretext);
...
void settextgameover()
{
	...
	text_game_over[0].setPosition(70, 400);

	text_game_over[1].setFont(font1);
	text_game_over[1].setFillColor(Color::White);
...
void scoreplayer() {
	...
	maxscoretext.setPosition(220, 300);
